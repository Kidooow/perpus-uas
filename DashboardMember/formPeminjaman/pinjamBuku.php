...
<html lang="en">
  ...
  <div class="p-4 mt-5">
      ...
      <div class="card-body d-flex flex-wrap gap-4 justify-content-center">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" placeholder="nim" aria-label="nim" aria-describedby="basic-addon1" value="<?= $item["nim"]; ?>" readonly>
            </div>
          <div class="input-group mb-3">
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <?php endforeach; ?>
        <!-- Ambil data NIIM user yang login-->
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Nim</span>
            <input type="number" name="nim" class="form-control" placeholder="nim" aria-label="nim" aria-describedby="basic-addon1" value="<?php echo htmlentities($_SESSION["member"]["nim"]); ?>" readonly>
        </div>
    <!--Ambil data id admin-->
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Ridho Naufalramzi</span> © 2024</p>
