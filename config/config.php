...
function pinjamBuku($dataBuku) {
  ...
  $cekDenda = mysqli_query($connection, "SELECT denda FROM pengembalian WHERE nim = $nim && denda > 0");
  ...
  // cek batas user meminjam buku berdasarkan nim
